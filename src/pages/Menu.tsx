      ...
      <div className="max-w-4xl mx-auto">
        ...
        <section className="mb-12">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-3xl font-bold">🥪 Subway Sandwich Menu with Prices</h2>
          </div>
          <Card className="p-6">
            <Table>
              <TableHeader>
        ...
        <section className="mb-12">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-3xl font-bold">🌯 Subway Wraps Menu with Prices</h2>
          </div>
          <Card className="p-6">
            <Table>
              <TableHeader>
        ...
        <section className="mb-12">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-3xl font-bold">🥗 Subway Protein Bowl Menu</h2>
          </div>
          <Card className="p-6">
            <Table>
              <TableHeader>
        ...
        <section>
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-3xl font-bold">🧁 Subway Cookies Price</h2>
          </div>
          <Card className="p-6">
        ...
        <section>
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-3xl font-bold">🍲 Subway Soup Menu</h2>
          </div>
          <Card className="p-6">
            <Table>
              <TableHeader>
        ...
        <section>
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-3xl font-bold">🌾 Subway Gluten-Free Menu</h2>
          </div>
          <Card className="p-6">
            <ul className="space-y-4">
        ...
        <section>
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-3xl font-bold">🧂 Subway Sauce Menu</h2>
          </div>
          <Card className="p-6">
        ...
        <section className="mt-12">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-3xl font-bold">🎉 Subway Catering Menu Prices</h2>
          </div>
          <Card className="p-6">
            <Table>
              <TableHeader>
